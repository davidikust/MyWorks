...
// В случае поломки функция возвращает -1, после чего сломавшийся процесс отправляет отчет и завершает работу
// Процесс 0 анализирует выполнение работы другими процессами и завершает работу, если он остался один.
